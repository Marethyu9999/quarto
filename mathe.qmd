...
- [Integrale](#integrale) ([Definition](#was-sind-integrale), Stammfunktion, Flächeninhalt, …)
  - *unwahscheinlich* Ober-/ Untersummen
- [Vektoren](#vektoren) (Grundlagen, 3d-Koordinatensystem, [Beträge](#beträge), [Addition](#addition), [Subtraktion](#subtraktion), [Multiplikation mit Skalaren](#multiplikation-mit-skalaren))
- [Geraden](#vektoren-und-geraden)
...
1. Die Formel finden: $\int_0^4 x^2 dx$
2. $f(x)$ finden (heißt die Zahlen vor dx lesen): $f(x)=x^2$
3. $F(x)$ finden (hochleiten): $F(x) = \frac{1}{3} * x^3$
4. $a$ und $b$ einsetzen und ausrechnen: $F(4) - F(0) = 21,\overline{3} + 0 = 21,\overline{3}$
